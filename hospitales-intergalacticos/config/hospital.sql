...
INSERT INTO doctor (hospital_id, name, last_name, speciality, university_degree, description, image)
VALUES 
    (2, 'Carlos', 'Gutiérrez Rojas', 'Oncología', 'Doctor en Medicina por la Universidad de Marte', 'El Dr. Carlos Gutiérrez Rojas es un oncólogo especializado en el tratamiento de cánceres interplanetarios. Con más de 18 años de experiencia, ha desarrollado terapias innovadoras que combinan quimioterapia avanzada y técnicas de inmunoterapia galáctica. Su enfoque multidisciplinario y su dedicación a la investigación lo han convertido en un referente en la lucha contra el cáncer en entornos espaciales.', 'oncologo.jpg'),
    (2, 'Laura', 'Mendoza Solís', 'Pediatría', 'Licenciada en Pediatría por la Universidad de Marte', 'La Dra. Laura Mendoza Solís es una pediatra con una pasión por el cuidado de los más pequeños. Especializada en medicina infantil en entornos de gravedad cero, ha desarrollado protocolos para garantizar el crecimiento saludable de niños en colonias espaciales. Su trato cálido y su enfoque preventivo la han convertido en una figura querida por familias de todo el sistema solar.', 'pediatra.jpeg'),
    (2, 'Roberto', 'Navarro Díaz', 'Neurología', 'Doctor en Neurología por la Universidad de Marte', 'El Dr. Roberto Navarro Díaz es un neurólogo especializado en trastornos del sistema nervioso en entornos espaciales. Con más de 20 años de experiencia, ha tratado a astronautas y colonos con enfermedades neurodegenerativas y lesiones cerebrales. Su trabajo en neuroplasticidad y rehabilitación neuronal ha sido pionero en la medicina interplanetaria.', 'neurologo.jpeg'),
    (2, 'Unidad Quirúrgica', 'QX-2000', 'Cirugía', 'Fábrica de médicos de la Academia Galáctica', 'QX-2000 es un robot quirúrgico diseñado para realizar operaciones de alta complejidad en entornos de gravedad cero. Equipado con inteligencia artificial avanzada y herramientas quirúrgicas nanométricas, puede realizar procedimientos con una precisión milimétrica. Su capacidad para adaptarse a diferentes anatomías lo hace indispensable en el quirófano.', 'unidad_quirurjica.jpg'),
    (2, 'Sofía', 'López Torres', 'Ginecología', 'Doctora en Ginecología por la Universidad de Marte', 'La Dra. Sofía López Torres es una ginecóloga especializada en salud reproductiva en entornos espaciales. Con más de 15 años de experiencia, ha ayudado a cientos de mujeres a tener embarazos y partos seguros en colonias interplanetarias. Su enfoque integral y su dedicación a la salud femenina la han convertido en una líder en su campo.', 'ginecologa.jpg'),
    (2, 'Unidad Diagnóstica', 'DX-5000', 'Diagnóstico', 'Fábrica de médicos de la Academia Galáctica', 'DX-5000 es un robot especializado en diagnóstico por imágenes. Equipado con tecnología de escaneo tridimensional y algoritmos de inteligencia artificial, puede detectar anomalías en tejidos y órganos con una precisión sin precedentes. Su capacidad para procesar grandes volúmenes de datos lo convierte en una herramienta esencial para el diagnóstico temprano.', 'unidad_diagnostica.jpg');

INSERT INTO doctor (hospital_id, name, last_name, speciality, university_degree, description, image)
VALUES 
    (3, 'Ana', 'García Ruiz', 'Dermatología', 'Doctora en Dermatología por la Universidad de Marte', 'La Dra. Ana García Ruiz es una dermatóloga especializada en el cuidado de la piel en entornos espaciales. Con más de 12 años de experiencia, ha desarrollado tratamientos innovadores para proteger la piel de la radiación cósmica y otros factores ambientales. Su enfoque preventivo y su dedicación a la salud cutánea la han convertido en una referente en su campo.', 'dermatologa.jpeg'),
    (3, 'Javier', 'Morales Castro', 'Ortopedia', 'Doctor en Ortopedia por la Universidad de Marte', 'El Dr. Javier Morales Castro es un ortopedista especializado en el tratamiento de lesiones musculoesqueléticas en entornos de gravedad cero. Con más de 15 años de experiencia, ha desarrollado prótesis y técnicas quirúrgicas avanzadas para pacientes de múltiples especies. Su trabajo en rehabilitación física ha sido fundamental para la recuperación de astronautas y colonos.', 'ortopedia.jpg'),
    (3, 'Unidad de Emergencias', 'ER-7000', 'Emergencias', 'Fábrica de médicos de la Academia Galáctica', 'ER-7000 es un robot especializado en medicina de emergencias. Equipado con sensores biométricos y herramientas de diagnóstico rápido, puede atender a pacientes críticos en cuestión de segundos. Su capacidad para operar en condiciones extremas lo hace indispensable en situaciones de crisis.', 'unidad_emergencias.jpg'),
    (3, 'Carmen', 'Vega Sánchez', 'Endocrinología', 'Doctora en Endocrinología por la Universidad de Marte', 'La Dra. Carmen Vega Sánchez es una endocrinóloga especializada en el tratamiento de trastornos hormonales en entornos espaciales. Con más de 10 años de experiencia, ha desarrollado terapias personalizadas para pacientes expuestos a condiciones extremas. Su enfoque integral y su dedicación a la investigación la han convertido en una líder en su campo.', 'endocrinologa.jpg'),
    (3, 'Unidad de Rehabilitación', 'RH-3000', 'Fisioterapia', 'Fábrica de médicos de la Academia Galáctica', 'RH-3000 es un robot especializado en fisioterapia y rehabilitación. Equipado con tecnología de estimulación muscular y sensores de movimiento, puede diseñar programas de recuperación personalizados para pacientes de múltiples especies. Su capacidad para adaptarse a diferentes necesidades lo hace indispensable en la rehabilitación interplanetaria.', 'unidad_rehabilitacion.jpg'),
    (3, 'Miguel', 'Torres Gómez', 'Psiquiatría', 'Doctor en Psiquiatría por la Universidad de Marte', 'El Dr. Miguel Torres Gómez es un psiquiatra especializado en el tratamiento de trastornos mentales en entornos espaciales. Con más de 12 años de experiencia, ha desarrollado terapias innovadoras que combinan técnicas tradicionales con realidad virtual terapéutica. Su enfoque humano y su dedicación a la salud mental lo han convertido en un referente en su campo.', 'psiquiatra.png');
    
INSERT INTO doctor (hospital_id, name, last_name, speciality, university_degree, description, image)
VALUES 
    (4, 'Isabel', 'Díaz Romero', 'Oftalmología', 'Doctora en Oftalmología por la Universidad de Marte', 'La Dra. Isabel Díaz Romero es una oftalmóloga especializada en el cuidado de la visión en entornos espaciales. Con más de 10 años de experiencia, ha desarrollado tratamientos innovadores para proteger los ojos de la radiación cósmica y otros factores ambientales. Su enfoque preventivo y su dedicación a la salud visual la han convertido en una referente en su campo.', 'oftalmologo.jpg'),
    (4, 'Unidad de Radiología', 'RD-4000', 'Radiología', 'Fábrica de médicos de la Academia Galáctica', 'RD-4000 es un robot especializado en radiología. Equipado con tecnología de escaneo tridimensional y algoritmos de inteligencia artificial, puede detectar anomalías en tejidos y órganos con una precisión sin precedentes. Su capacidad para procesar grandes volúmenes de datos lo convierte en una herramienta esencial para el diagnóstico temprano.', 'unidad_radiologica.jpg'),
    (4, 'Alejandro', 'Sánchez López', 'Urología', 'Doctor en Urología por la Universidad de Marte', 'El Dr. Alejandro Sánchez López es un urólogo especializado en el tratamiento de trastornos del sistema urinario en entornos espaciales. Con más de 15 años de experiencia, ha desarrollado técnicas quirúrgicas mínimamente invasivas para pacientes de múltiples especies. Su enfoque innovador y su dedicación a la investigación lo han convertido en un referente en su campo.', 'urologo.jpg'),
    (4, 'Unidad de Cuidados Intensivos', 'ICU-1000', 'Intensiva', 'Fábrica de médicos de la Academia Galáctica', 'ICU-1000 es un robot especializado en cuidados intensivos. Equipado con sensores biométricos y herramientas de monitoreo avanzado, puede atender a pacientes críticos en tiempo real. Su capacidad para operar en condiciones extremas lo hace indispensable en unidades de cuidados intensivos.', 'unidad_intensivo.png'),
    (4, 'Patricia', 'Romero García', 'Nutrición', 'Doctora en Nutrición por la Universidad de Marte', 'La Dra. Patricia Romero García es una nutricionista especializada en el diseño de dietas para entornos espaciales. Con más de 10 años de experiencia, ha desarrollado planes alimenticios personalizados para astronautas y colonos. Su enfoque integral y su dedicación a la salud nutricional la han convertido en una líder en su campo.', 'nutricionista.jpg'),
    (4, 'Unidad de Farmacología', 'PH-6000', 'Farmacología', 'Fábrica de médicos de la Academia Galáctica', 'PH-6000 es un robot especializado en farmacología. Equipado con inteligencia artificial avanzada, puede diseñar y administrar medicamentos personalizados para pacientes de múltiples especies. Su capacidad para analizar interacciones farmacológicas lo hace indispensable en el tratamiento de enfermedades complejas.', 'unidad_farmacologica.jpg');
...
INSERT INTO new (tittle, short_description, image)
VALUES 
	("Trobulus Klink vuelve", "El prestigioso médico, que se creía muerto, vuelve con una nueva historia", "medico.jpeg"),
	("Un virus arrasa Lumiere", "El planeta Lumiere se vuelve prácticamente inaccesible debido al virus KLM-3030", "virus.jpg"),
    ("Corvotroxin", "El nuevo tratamiento contra la metamorfosis repentina", "medicacion.jpg"),
    ("Trobulus klink engaña", "Todo fue una farsa para ganar fama", "medico.jpeg");
    
UPDATE new SET active=0 WHERE new_id=4;
